...
ActiveRecord::Base.transaction do
  member_1 = User.create!(name: 'Test Member', email: 'misc@epicco.me', password: 'password', password_confirmation: 'password', uid: SecureRandom.hex(10), provider: :email, confirmed_at: Time.now)
  ...
  WebsiteMember.create!(user_id: member_1.id, website_id: website_1.id, role: 1)
