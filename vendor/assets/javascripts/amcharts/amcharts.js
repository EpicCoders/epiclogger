        ...
        parseDatesDraw: function() {
            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    m = l = p;
                    if (!isNaN(u))
                        for (h = 1; h < v; h += u) this.gridAlpha = this.minorGridAlpha, f = p + z * h, f = d.resetDateToMin(new Date(f), A, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0,
                        ...
                        for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), c = this.minCalc, h && (r++, c = this.maxCalc - r * x), g = t; g < r; g += p)
                            if (t = x * g + c, t = d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t)
                                if (isNaN(z) || Number(d.toFixed(t, z)) == t) {
                                    if (!0 === h)
                                        if (u > this.logGridLimit) t = Math.pow(10, g);
                    ...
                    if (f.hasOwnProperty(g)) {
                        ...
                        if (k.includeInMinMax && (!k.hidden || this.includeHidden)) {
                            ...
                            if (this.minMaxField) l = k[this.minMaxField], l < c && (c = l), l > e && (e = l);
                                ...
                                for (var m in k) k.hasOwnProperty(m) && "percents" != m && "total" != m && (l = k[m], l < c && (c = l),
                                    l > e && (e = l))
                        }
                    }
            }
        ...
        createSerialGraph: function() {
            ...
            for (L = Q; L <= ia; L++) {
                ...
                if (Ia) {
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(W)) x || (this.drawLineGraph(z, v, U, V), z = [], v = [], U = [], V = []);
                            else {
                    ...
                    if (!I && !isNaN(W)) {
                        ...
                        if (this.end - this.start <= Ub || 0 === Ub) {
                            var Vb = this.createBullet(w, ka, la, L),
                                Wb = this.labelText;
                            if (Wb && !isNaN(wa) && !isNaN(wa)) {
                                var gc = this.createLabel(w, Wb),
                                    Xb = 0;
                                Vb && (Xb = Vb.size);
        ...
        dispatchPanEvent: function() {
            if (this.mouseIsDown) {
                var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3),
                    b = d.roundTo((this.mouseY -
                        this.mouseY0) / this.height, 3),
            ...
            if (k) {
                ...
                if (n.mouseIsOver) {
                    ...
                    if (this.resizingLeft) {
                        if (m)
                            if (c = e,
                                e = r, e < f && (e = f), isNaN(e) && (e = f), e > p + f && (e = p + f), a = !0 === b ? c - e : k + c - e, 0 > a) this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("y", c + k - f);
                            else {
                                if (0 === a || isNaN(a)) a = .1;
                                g.setAttr("y", e - f);
                                g.setAttr("height", a)
        ...
        handleBgClick: function() {
            ...
            if (!a.resizingRight && !a.resizingLeft) {
                ...
                a.updateOnReleaseOnly ? (a.skipEvent = !1, h.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) :
                    (a.animating = !0, c = Math.round(c), m ? h.animate({
                        y: c
                    }, e, ">") : h.animate({
                        x: c
...
(function() {
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        var v = 1 / 180 * Math.PI,
            ...
            y = b + Math.sin(e * v) * f,
            B = c - Math.cos(e * v) * g,
            D = b + Math.sin((e + h) * v) * f,
            C = c - Math.cos((e + h) * v) * g,
            J = b + Math.sin((e + h) * v) * k,
            v = c - Math.cos((e + h) * v) * u,
            H = {
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b,
                        n, "graph-stroke"), g.push(n), a.bullet && (a.hidden || (e = a.bulletColorR), n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)), p = 0, n = m, q = m / 3;
                    else {
                        var t;
