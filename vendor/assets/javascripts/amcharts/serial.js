(function() {
    ...
    e.AmRectangularChart = e.Class({
        ...
        adjustMargins: function(a, b) {
            ...
            a.enabled && ("top" == c ? b ? this.marginLeftReal +=
        ...
        updateChartScrollbar: function(a, b) {
            if (a) {
                ...
                var c = this.marginTopReal,
                    ...
                    f = this.dy,
                    e = a.offset;
                "top" == a.position ? b ? (a.y = c, a.x = d - g - e) : (a.y = c - g + f - e, a.x = d + h) : b ? (a.y = c + f, a.x = d + this.plotAreaWidth + h + e) : (a.y = c + this.plotAreaHeight +
                    e, a.x = this.marginLeftReal)
            }
        },
        showZB: function(a) {
            var b = this.zbSet;
        ...
        handleMouseDown: function(a) {
            ...
            b && b.handleMouseDown && !this.rolledOverZB &&
                b.handleMouseDown(a)
        },
        update: function() {
        ...
        handleCursorZoom: function(a) {
            if (this.skipZoomed) this.skipZoomed = !1;
                ...
                this.handleCursorZoomReal(b +
                    h * (c - b), b + f * (c - b), g + e * (d - g), g + k * (d - g), a)
            }
        },
...
(function() {
    ...
    e.AmSerialChart = e.Class({
        ...
        zoom: function(a, b) {
            ...
            this.chartCursor && this.chartCursor.hideCursorReal();
        ...
        countColumns: function() {
            ...
            for (l = 0; l < b; l++) {
                ...
                if ("none" == k || "3d" == k) {
                    h = !1;
                    for (f = 0; f < c; f++) d = this.graphs[f], d.valueAxis == e && "column" == d.type &&
                        (d.clustered ? (d.tcc = 1, d.newStack && (a = 0), d.hidden || (d.columnIndex = a, a++)) : d.hidden || (h = !0, d.tcc = 1, d.columnIndex = 0));
                    h && 0 === a && (a = 1)
                }
                if ("3d" == k) {
                    e = 1;
                    for (l = 0; l < c; l++) d = this.graphs[l], d.newStack && e++, d.depthCount = e, d.tcc = a;
                    a = e
                }
            }
            return a
        ...
        getClosestIndex: function(a, b, c, d, e, h) {
            ...
            var f = e + Math.round((h - e) / 2),
                l = a[f][b];
            return c == l ? f : 1 >= h -
                e ? d ? e : Math.abs(a[e][b] - c) < Math.abs(a[h][b] - c) ? e : h : c == l ? f : c < l ? this.getClosestIndex(a, b, c, d, e, f) : this.getClosestIndex(a, b, c, d, f, h)
        },
        ...
        zoomToDates: function(a, b) {
            ...
            if (c)
                if (this.categoryAxis.equalSpacing) {
                    ...
                    b = e.resetDateToMin(b,
                        this.categoryAxis.minPeriod, 1);
        ...
        formatPeriodString: function(a, b) {
            if (b) {
                ...
                for (var l = 0; l < c.length; l++) {
                    for (var k =
                            c[l], m = 0, p = 0, n, r, w, z, u, q = 0, D = 0, v, t, x, B, A, G = this.start; G <= this.end; G++) {
                        var y = h[G];
                        if (y && (y = y.axes[g.id].graphs[b.id])) {
                            ...
                            if (y.percents && (y = y.percents[k], !isNaN(y))) {
                                isNaN(v) && (v = y);
                                t = y;
                                if (isNaN(x) || x > y) x = y;
                                if (isNaN(B) ||
        ...
        formatString: function(a, b, c) {
            if (b) {
                ...
                if (void 0 !== a) {
                    ...
                    "date" == h.type &&
                        (h = e.formatDate(new Date(b.values.value), d.dateFormat, this), f = RegExp("\\[\\[value\\]\\]", "g"), a = a.replace(f, h), h = e.formatDate(new Date(b.values.open), d.dateFormat, this), f = RegExp("\\[\\[open\\]\\]", "g"), a = a.replace(f, h));
                    ...
                    a = e.formatValue(a, b.values, ["percents"], h); - 1 != a.indexOf("[[") && (a = e.formatDataContextValue(a,
                        b.dataContext)); - 1 != a.indexOf("[[") && b.graph.customData && (a = e.formatDataContextValue(a, b.graph.customData));
        ...
        updateChartCursor: function() {
            ...
            if (a) {
                ...
                this.rotate ? (a.vLineEnabled = l, a.hZoomEnabled = h, a.vZoomEnabled =
                    f) : (a.hLineEnabled = l, a.vZoomEnabled = h, a.hZoomEnabled = f);
                ...
                b && (b.balloonTextFunction = a.categoryBalloonFunction, a.categoryLineAxis = b, b.balloonText = a.categoryBalloonText, a.categoryBalloonEnabled && ((f =
                    b.balloon) || (f = {}), f = e.extend(f, this.balloon, !0), f.fillColor = d, f.balloonColor = d, f.fillAlpha = c, f.borderColor = d, f.color = g, b.balloon = f), b.balloon && (b.balloon.enabled = a.categoryBalloonEnabled))
            }
        },
            ...
            if (a.panning) this.handleCursorHide(a);
                ...
                if (d) {
                    ...
                    if (g = this.chartData[g]) {
                        ...
                        if (this.prevCursorItem !=
                            g || k != this.prevMostCloseGraph) {
                            m = [];
...
(function() {
    var e = window.AmCharts;
    e.Cuboid = e.Class({
        construct: function(a, b, c, d, e, h, f, l, k, m, p, n, r, w, z, u, q) {
            this.set = a.set();
            this.container = a;
            this.h = Math.round(c);
            this.w = Math.round(b);
        ...
        draw: function() {
            ...
            var x, B, A, G, y, C, F, L, M, Q = k;
            u && (k = 0);
            var E, H, I, J, K = this.rotate;
            if (0 < Math.abs(h) || 0 < Math.abs(f))
                if (isNaN(q)) F = t, t = e.adjustLuminosity(v, -.2), t = e.adjustLuminosity(v, -.2), x = e.polygon(b, [0, h, d + h, d, 0], [0, f, f, 0, 0],
                    ...
                    K ? (N = g / 2, t = h / 2, P = g / 2, O =
                        d + h / 2, H = Math.abs(g / 2), E = Math.abs(h / 2)) : (t = d / 2, N = f / 2, O = d / 2, P = g + f / 2 + 1, E = Math.abs(d / 2), H = Math.abs(f / 2));
                    I = E * q;
                    J = H * q;.1 < E && .1 < E && (x = e.circle(b, E, v, k, m, p, n, !1, H), x.translate(t, N));.1 < I && .1 < I && (F = e.circle(b, I, e.adjustLuminosity(v, .5), k, m, p, n, !1, J), F.translate(O, P))
                }
            k = Q;
            1 > Math.abs(g) && (g = 0);
            1 > Math.abs(d) && (d = 0);
...
(function() {
    ...
    e.CategoryAxis = e.Class({
        ...
        draw: function() {
            ...
            if (e.ifArray(a)) {
                ...
                if (this.parseDates && !this.equalSpacing) this.lastTime = a[a.length - 1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * r), this.minPeriod,
                    1, p).getTime(), this.timeDifference = this.endTime - this.startTime, this.parseDatesDraw();
                    ...
                    if (this.cellWidth = this.getStepWidth(f), f < l && (l = f), h += this.start, this.stepWidth = this.getStepWidth(f), 0 < l)
                        for (v = Math.floor(f / l), r = this.chooseMinorFrequency(v), f = h, f / 2 == Math.round(f / 2) && f--, 0 > f && (f = 0), l = 0, this.widthField && (f = this.start), this.end - f + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle), b = f; b <= this.end + 2; b++) {
                            ...
                            l++;
                            A = this.cellWidth;
                            D && (A = NaN, this.ignoreAxisWidth || !c.autoMargins) && (A = "right" == this.position ?
                ...
                for (b = 0; b < x; b++)
                    if (k = this.guides[b], p = v = v = q = d = NaN, m = k.above, k.toCategory && (v = c.getCategoryIndexByValue(k.toCategory), isNaN(v) || (d = this.getCoordinate(v - h), k.expand &&
                ...
                if (c = c.chartCursor) D ? c.fixHeight(this.cellWidth) : (c.fixWidth(this.cellWidth), c.fullWidth &&
        ...
        showBalloonAt: function(a) {
            a = this.parseDates ? this.dateToCoordinate(new Date(a)) :
